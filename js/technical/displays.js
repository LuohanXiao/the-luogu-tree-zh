...
function challengeButtonText(layer, id) {
    return (player[layer].activeChallenge==(id)?(canCompleteChallenge(layer, id)?"完成":"提前离开"):(hasChallenge(layer, id)?"完成":"开始"))
